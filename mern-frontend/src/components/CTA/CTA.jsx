      ...
      <div className="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        ...
        <div className="lg:mt-0 lg:flex-shrink-0 mt-8">
          <div className="mt-12 inline-flex rounded-md shadow">
            <button
              type="button"
              className="py-4 px-6 bg-indigo-600 hover:bg-white text-white hover:text-indigo-600 hover:outline w-full transition ease-in duration-100 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
            >
              Get started
            </button>
          </div>
